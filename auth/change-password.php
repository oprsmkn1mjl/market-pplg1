...
//tangkap pesan di url jika terjadi error
if (isset($_GET['msg'])) {
  $msg = $_GET['msg'];
} else {
  $msg = '';
        ...
        <form action="" method="post">
          <div class="card-header">
            ...
            <div class="card-tools">
              <button type="submit" name="simpan" class="btn btn-primary btn-sm float-right"><i class="fas fa-edit fa-sm"></i>
                Submit</button>
              <button type="reset" name="reset" class="btn btn-danger btn-sm float-right mr-1"><i class="fas fa-times fa-sm"></i>
                Reset</button>
            </div>
          </div>
          <div class="card-body">
