...
<<<<<<< HEAD
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="<?= $main_url ?>assets/AdminLTE/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
...
<body class="hold-transition login-page" id="bg-login">
    <div class="login-box slide-down" style="margin-top: -70px;">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="#" class="h1"><b>Market</b>PPLG</a>
            </div>
            <div class="card-body">
                ...
                <p class="my-3 text-center">
                    <strong>Copyright &copy; 2024 <span class="text-info">Market PPLG</span></strong>
                </p>
            </div>
            <!-- /.card-body -->
        </div>
    ...
    <!-- AdminLTE App -->
    <script src="<?= $main_url ?>assets/AdminLTE/dist/js/adminlte.min.js"></script>
=======
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
